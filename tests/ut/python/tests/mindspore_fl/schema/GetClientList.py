...
class GetClientList(object):
    ...
    @classmethod
    def GetRootAsGetClientList(cls, buf, offset=0):
...
def GetClientListStart(builder):
...
def GetClientListAddFlId(builder, flId):
...
def GetClientListAddIteration(builder, iteration):
...
def GetClientListAddTimestamp(builder, timestamp):
...
def GetClientListAddSignature(builder, signature):
...
def GetClientListStartSignatureVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartSignatureVector(builder, numElems)
def End(builder): return builder.EndObject()
def GetClientListEnd(builder):
