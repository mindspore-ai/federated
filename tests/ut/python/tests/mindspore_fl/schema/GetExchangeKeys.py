...
class GetExchangeKeys(object):
    ...
    @classmethod
    def GetRootAsGetExchangeKeys(cls, buf, offset=0):
...
def GetExchangeKeysStart(builder):
...
def GetExchangeKeysAddFlId(builder, flId):
...
def GetExchangeKeysAddIteration(builder, iteration):
...
def GetExchangeKeysAddTimestamp(builder, timestamp):
...
def GetExchangeKeysAddSignature(builder, signature):
...
def GetExchangeKeysStartSignatureVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartSignatureVector(builder, numElems)
def End(builder): return builder.EndObject()
def GetExchangeKeysEnd(builder):
