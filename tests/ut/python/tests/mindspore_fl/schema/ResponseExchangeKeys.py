...
class ResponseExchangeKeys(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ResponseExchangeKeys()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsResponseExchangeKeys(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # ResponseExchangeKeys
...
def ResponseExchangeKeysStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddRetcode(builder, retcode): builder.PrependInt32Slot(0, retcode, 0)
def ResponseExchangeKeysAddRetcode(builder, retcode):
...
def ResponseExchangeKeysAddReason(builder, reason):
...
def ResponseExchangeKeysAddNextReqTime(builder, nextReqTime):
