...
class GetShareSecrets(object):
    ...
    @classmethod
    def GetRootAsGetShareSecrets(cls, buf, offset=0):
...
def GetShareSecretsStart(builder):
...
def GetShareSecretsAddFlId(builder, flId):
...
def GetShareSecretsAddIteration(builder, iteration):
...
def GetShareSecretsAddTimestamp(builder, timestamp):
...
def GetShareSecretsAddSignature(builder, signature):
...
def GetShareSecretsStartSignatureVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartSignatureVector(builder, numElems)
def End(builder): return builder.EndObject()
def GetShareSecretsEnd(builder):
