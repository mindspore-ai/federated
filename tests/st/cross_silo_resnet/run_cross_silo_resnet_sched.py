...
# ============================================================================
"""start running resnet scheduler of cross silo mode"""

import os
import argparse
import subprocess

parser = argparse.ArgumentParser(description="Run run_cross_silo_resnet_sched.py case")
...
cmd_sched += "python ${self_path}/../../train.py"
