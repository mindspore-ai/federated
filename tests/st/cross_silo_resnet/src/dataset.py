...
def create_dataset1(dataset_path, do_train, batch_size=32, train_image_size=224,
    ...
    if device_num == 1:
        ...
        data_set = ds.Cifar10Dataset(dataset_path, num_parallel_workers=get_num_parallel_workers(12),
