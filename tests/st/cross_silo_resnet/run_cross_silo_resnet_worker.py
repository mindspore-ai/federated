...
parser = argparse.ArgumentParser(description="Run run_cross_silo_resnet_worker.py case")
...
for i in range(local_worker_num):
    ...
    cmd_worker += "python ${self_path}/../../train.py"
    ...
    cmd_worker += " --device_id=" + str(device_id + i)
