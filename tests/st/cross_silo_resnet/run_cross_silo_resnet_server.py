...
# ============================================================================
"""start running resnet server of cross silo mode"""

import os
import argparse
import subprocess

parser = argparse.ArgumentParser(description="Run run_cross_silo_resnet_server.py case")
...
parser.add_argument("--local_server_num", type=int, default=4)
...
for i in range(local_server_num):
    ...
    cmd_server += "python ${self_path}/../../train.py"
