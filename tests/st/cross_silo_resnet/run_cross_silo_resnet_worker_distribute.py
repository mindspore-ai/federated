...
# ============================================================================
"""start running resnet distributed worker of cross silo mode"""
...
parser = argparse.ArgumentParser(description="Run run_cross_silo_resnet_worker_distributed.py case")
...
cmd_worker += " --output-filename log_output --merge-stderr-to-stdout python ${self_path}/../../train.py"
