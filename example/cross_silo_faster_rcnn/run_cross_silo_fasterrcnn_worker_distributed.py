...
# ============================================================================
"""start running faster rcnn worker of cross silo mode"""
import ast
import os
import argparse
import subprocess

parser = argparse.ArgumentParser(description="Run run_cross_silo_fasterrcnn_worker_distributed.py case")
...
cmd_worker += "mpirun --allow-run-as-root -n " + str(device_num)
cmd_worker += " --output-filename log_output --merge-stderr-to-stdout python ${self_path}/../../test_fl_fasterrcnn.py"
