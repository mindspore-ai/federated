...
from mindspore_federated._mindspore_federated import free_tee_cut_layer
from run_vfl_train_local import construct_local_dataset
from network_config import config
from wide_and_deep import AUCMetric
from wide_and_deep_tee import LeaderNet, LeaderLossNet, LeaderGradNet, LeaderEvalNet, \
    FollowerNet, FollowerLossNet


if __name__ == '__main__':
    logging.basicConfig(filename='log_local_{}_tee.txt'.format(config.device_target), level=logging.INFO)
