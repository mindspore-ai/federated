...
# Execute Wide&Deep split nn demo leader training on Criteo dataset with type of "csv".
...
echo "run_vfl_process_leader.py is started."
rm -rf $WORKPATH/vfl_process_leader.log
nohup python $WORKPATH/run_vfl_process_leader.py \
    ...
    --remote_server_address=$REMOTE_SERVER_ADDRESS >> $WORKPATH/vfl_process_leader.log 2>&1 &
