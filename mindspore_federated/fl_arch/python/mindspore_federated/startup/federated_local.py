...
class FLServerJob:
    ...
    Args:
        yaml_config (str): The yaml file path. More detail see `federated_server_yaml <https://gitee.com/mindspore/federated/blob/r0.1/docs/api/api_python_en/horizontal/federated_server_yaml.md>`_.
