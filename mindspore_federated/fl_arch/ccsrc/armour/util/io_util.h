...
void CreateClientPSIInitProto(datajoin::ClientPSIInitProto *client_init_proto, const ClientPSIInit &client_init) {
...
void CreateServerPSIInitProto(datajoin::ServerPSIInitProto *server_init_proto, const ServerPSIInit &server_init) {
...
void CreateBobPbProto(datajoin::BobPbProto *bob_p_b_proto, const BobPb &bob_p_b) {
...
void Recv(BobPb *bob_p_b) {
  ...
  for (const auto &item : bob_p_b_proto.p_b_vct()) {
    p_b_vct.push_back(item);
  }
...
void CreateAlicePbaAndBFProto(datajoin::AlicePbaAndBFProto *alice_pba_bf_proto, const AlicePbaAndBF &alice_pba_bf) {
...
void Recv(AlicePbaAndBF *alice_p_b_a_bf) {
  ...
  std::vector<std::string> p_b_vct;
  for (const auto &item : alice_p_b_a_bf_proto.p_b_a_vct()) {
    p_b_vct.push_back(item);
  }
...
void CreateBobAlignResultProto(datajoin::BobAlignResultProto *bob_alice_result_proto,
                               const BobAlignResult &bob_align_result) {
...
void Recv(BobAlignResult *bob_align_result) {
  ...
  for (const auto &item : bob_align_result_proto.align_result()) {
    align_result.push_back(item);
  }
...
void CreateAliceCheckProto(datajoin::AliceCheckProto *alice_check_proto, const AliceCheck &alice_check) {
...
void Recv(AliceCheck *alice_check) {
  ...
  for (const auto &item : alice_check_proto.wrong_id()) {
    wrong_id_vct.push_back(item);
  }
