...
class Iteration {
 public:
  ...
  void RegisterEventCallback(const std::shared_ptr<fl::core::ServerNode> &server_node);
  ...
  void InitRounds(const std::vector<std::shared_ptr<fl::core::CommunicatorBase>> &communicators,
  ...
  void SetFileConfig(const std::shared_ptr<fl::core::FileConfiguration> &file_configuration);
 ...
 private:
  ...
  void HandleSyncIterationRequest(const std::shared_ptr<fl::core::MessageHandler> &message);
  ...
  void HandleNotifyLeaderMoveToNextIterRequest(const std::shared_ptr<fl::core::MessageHandler> &message);
  ...
  void HandlePrepareForNextIterRequest(const std::shared_ptr<fl::core::MessageHandler> &message);
  ...
  void HandleMoveToNextIterRequest(const std::shared_ptr<fl::core::MessageHandler> &message);
  ...
  void HandleEndLastIterRequest(const std::shared_ptr<fl::core::MessageHandler> &message);
  ...
  std::shared_ptr<fl::core::FileConfiguration> file_configuration_;
