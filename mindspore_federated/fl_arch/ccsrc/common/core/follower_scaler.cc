...
void FollowerScaler::RegisterScaleEventCallbacks() {
  ...
  node_->RegisterEventCallback(fl::core::ClusterEvent::READY_FOR_SCALE_OUT, ready_for_scale_out_event_callback_);
  node_->RegisterEventCallback(fl::core::ClusterEvent::READY_FOR_SCALE_IN, ready_for_scale_in_event_callback_);
  node_->RegisterEventCallback(fl::core::ClusterEvent::CLUSTER_SCALE_OUT_DONE, scale_out_done_event_callback_);
  node_->RegisterEventCallback(fl::core::ClusterEvent::CLUSTER_SCALE_IN_DONE, scale_in_done_event_callback_);
  node_->RegisterEventCallback(fl::core::ClusterEvent::CLUSTER_SCALE_OUT_ROLLBACK_DONE,
