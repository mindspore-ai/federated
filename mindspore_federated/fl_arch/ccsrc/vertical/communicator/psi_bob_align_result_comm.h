...
#ifndef MINDSPORE_FL_ARCH_CCSRC_VERTICAL_PSI_BOB_ALIGN_RESULT_COMMUNICATOR_H_
#define MINDSPORE_FL_ARCH_CCSRC_VERTICAL_PSI_BOB_ALIGN_RESULT_COMMUNICATOR_H_
...
namespace mindspore {
namespace fl {
class BobAlignResultCommunicator : public AbstractCommunicator {
 public:
  BobAlignResultCommunicator() = default;
  ~BobAlignResultCommunicator() = default;
...
#endif  // MINDSPORE_FL_ARCH_CCSRC_VERTICAL_PSI_BOB_ALIGN_RESULT_COMMUNICATOR_H_
